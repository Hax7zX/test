...
public class ConfigManager {
	...
	public void saveGroupsConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + groupsConfigFile, e);
		}
	}
	...
	public void saveListsConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + listsConfigFile, e);
		}
	}
	...
	public void saveKSConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + ksConfigFile, e);
		}
	}
	...
	public void saveHKSConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + hksConfigFile, e);
		}
	}
	...
	public void saveKillsConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + killsConfigFile, e);
		}
	}
	...
	public void saveDeathsConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + deathsConfigFile, e);
		}
	}
	...
	public void saveCombatConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + combatConfigFile, e);
		}
	}
	...
	public void saveReportsConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + reportsConfigFile, ex);
		}
	}
	...
	public void saveDataConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + dataConfigFile, ex);
		}
	}
	...
	public void save1v1Config() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + onev1ConfigFile, ex);
		}
	}
	...
	public void saveTeamConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + teamConfigFile, ex);
		}
	}

	public void reloadTeamListConfig() {
		if (teamListConfigFile == null) {
			teamListConfigFile = new File(plugin.getDataFolder(),
					"teamlist.yml");
		}

		teamListConfig = YamlConfiguration
				.loadConfiguration(teamListConfigFile);
	...
	public void saveTeamListConfig() {
		...
		try {
			...
			plugin.getLogger().log(Level.SEVERE,
					"Could not save config to " + teamListConfigFile, ex);
		}
	}
}
